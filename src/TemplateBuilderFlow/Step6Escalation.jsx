...
export default function Step6Escalation({ formData, onChange }) {
    ...
    <div style={{ overflowY:"auto", height:"100%", fontFamily:F }}>
      <div style={{ maxWidth:1080, margin:"0 auto", padding:"28px 24px 100px" }}>
        ...
        <div style={{ marginBottom: 20 }}>
          <h2 style={{ margin:"0 0 5px", fontSize:20, fontWeight:700, color:C.g6, fontFamily:F }}>Audit Escalation</h2>
          <p style={{ margin:0, fontSize:13, color:C.g5, fontFamily:F }}>Define automated actions triggered after an audit is submitted based on its overall outcome.</p>
        </div>
